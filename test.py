...
def pre_processing_dataset():
    num_col = ['Trip_Distance_km', 'Base_Fare', 'Per_Km_Rate', 'Per_Minute_Rate', 'Trip_Duration_Minutes', 'Trip_Price']
    cat_cols = ['Time_of_Day', 'Day_of_Week', 'Traffic_Conditions', 'Weather', 'Passenger_Count']
    columns = {0: 'Trip_Distance_km', 1: 'Time_of_Day', 2: 'Day_of_Week', 3: 'Passenger_Count', 4: 'Traffic_Conditions',
               5: 'Weather', 6: 'Base_Fare', 7: 'Per_Km_Rate', 8: 'Per_Minute_Rate', 9: 'Trip_Duration_Minutes',
               10: 'Trip_Price'}
...
def eval_models():
    ...
    print(evaluate(y_test,lr[1]))
    print(evaluate(y_test,dt[1]))
    print(evaluate(y_test,rf[1]))
